(function() {
  ...
  this.JSREPL.prototype.Engines.prototype.Lisp = (function() {
    function Lisp(input, output, result, error, sandbox, ready) {
      var Javathcript, f, _i, _len, _ref;
      this.error = error;
      ...
      Javathcript.evalMulti(this.sandbox.JSREPL.prototype.Library, (function() {}), ready);
    }
