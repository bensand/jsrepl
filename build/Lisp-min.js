...
Javathcript.UnevaluatedObj = function() {};

Javathcript.Atom = (function() {
  function Atom(s) {
    this.CLASS = "Atom";
    this.name = s;
  }
...
var Util = function () {
  ...
  Util.prototype.getFile = function getFile(url, successHandler, failureHandler, timeout, timeoutHandler) {
    ...
    req.onreadystatechange = function (aEvt) {
      ...
      else if (failureHandler != null) failureHandler(url, req.status)
    };
    req.send(null);
